      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className="pointer-events-none absolute z-50 min-w-[15rem] overflow-hidden rounded-lg border border-orange-200 bg-[#ff4d2d] text-white shadow-xl ring-1 ring-orange-300"
            style={{
              top: position.y,
              left: position.x,
            }}
