...
function EditItem() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const result = await api.post(`${BASE_URL}/api/item/edit-item/${itemId}`, formData, { withCredentials: true });
    ...
    useEffect(() => {
        const handleGetItemById = async () => {
            try {
                const result = await api.get(`${BASE_URL}/api/item/get-by-id/${itemId}`, { withCredentials: true });
