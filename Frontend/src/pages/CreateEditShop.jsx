...
function CreateEditShop() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const result = await axios.post(`${BASE_URL}/api/shop/create-edit`, formData, { withCredentials: true })
                ...
                >
                    ...
                    <div className='space-y-2'>
                        ...
                        <div className='relative group'>
                            ...
                            <div className={`w-full h-56 rounded-[2rem] border-2 border-dashed transition-all flex flex-col items-center justify-center overflow-hidden relative ${frontendImage ? 'border-[#ff4d2d]' : 'border-gray-400 bg-gray-50 group-hover:border-[#ff4d2d]'}`}>
                                {frontendImage ? (
                                    <>
