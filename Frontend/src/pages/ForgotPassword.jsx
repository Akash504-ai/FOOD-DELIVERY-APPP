...
function ForgotPassword() {
  ...
  const iconStyle = "absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[#ff4d2d] transition-colors duration-300";
  const inputFieldStyle = "w-full bg-gray-50 border border-gray-200 rounded-2xl pl-12 pr-4 py-4 outline-none focus:bg-white focus:ring-4 focus:ring-orange-100 focus:border-[#ff4d2d] transition-all duration-300 font-medium shadow-inner";
      ...
      <div className='relative z-10 bg-white/95 backdrop-blur-md rounded-[2.5rem] shadow-[0_25px_60px_-15px_rgba(0,0,0,0.15)] w-full max-w-md p-8 md:p-10 border border-gray-200'>
        ...
        <div className='flex items-center justify-between mb-8'>
          ...
          <div className="text-right">
            ...
            <p className='text-[10px] text-gray-500 font-black uppercase tracking-[0.2em]'>Step {step} of 3</p>
          </div>
        </div>
        ...
        {step === 1 && (
          <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500 text-sm mt-1">Enter your email to receive a secure code.</p>
            </div>
        ...
        {step === 2 && (
          <div className="animate-in fade-in slide-in-from-right-2 duration-300">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-black text-gray-800 tracking-tight">Verify Code</h2>
              <p className="text-gray-500 text-sm mt-1">Sent to <span className="text-gray-900 font-bold">{email}</span></p>
            </div>

            <div className="mb-6">
              <input 
                type="text" 
                className="w-full bg-gray-50 border border-gray-200 rounded-2xl px-4 py-5 outline-none focus:bg-white focus:ring-4 focus:ring-orange-100 focus:border-[#ff4d2d] transition-all font-black text-center text-3xl tracking-[0.4em]"
                placeholder='000000' 
            ...
            <button 
              ...
              disabled={loading}
            >
              {loading ? <ClipLoader size={24} color='white' /> : "Confirm Code"}
            </button>
          </div>
        )}
        ...
        {step === 3 && (
          <div className="animate-in fade-in slide-in-from-right-2 duration-300">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-black text-gray-800 tracking-tight">New Password</h2>
              <p className="text-gray-500 text-sm mt-1">Choose a secure password.</p>
            </div>
            ...
            <button 
              ...
              disabled={loading}
            >
              {loading ? <ClipLoader size={24} color='white' /> : "Update Password"}
            </button>
          </div>
        )}
