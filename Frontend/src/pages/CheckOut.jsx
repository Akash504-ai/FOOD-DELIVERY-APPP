          ...
          <div className="w-full lg:w-2/3 space-y-8">
            ...
            <section className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-gray-100">
              ...
              <div className="flex gap-3 mb-6">
                ...
                <button
                  className="bg-gray-900 text-white p-4 rounded-2xl hover:bg-black transition-all shadow-lg shadow-black/10"
            ...
            <section className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-gray-100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                >
                  <div
                    className={`p-4 rounded-2xl transition-colors ${paymentMethod === "cod" ? "bg-[#ff4d2d] text-white" : "bg-gray-100 text-gray-400 group-hover:text-gray-600"}`}
                  >
